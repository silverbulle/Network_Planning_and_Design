# 云数据中心基础设施模块 (Cloud Datacenter Infrastructure)

本模块对应"summer课堂"**10-x 系列课件**，聚焦数据中心服务器、存储、虚拟化、容灾、视频会议等基础设施技术，与前 9 章"网络规划设计"模块互补。

> ℹ️ 各章节内容对照 PDF 课件逐章补充中，部分章节暂为骨架占位。
