...
![图2-1 存储架构拓扑](./assets/ch13_storage_topo.png){width="85%"}
...
![图2-1 2019年案例网络拓扑](./assets/ch13_2019_topo.png){width="85%"}
...
![图2-1 数据中心网络拓扑](./assets/ch13_fig2-1_topology.png){width="80%"}
...
<p><strong>图1：使用 FCoE 前（每台服务器至少一个 HBA 卡，一个以太网卡）</strong></p>
<img src="./assets/ch13_fcoe_before.png" width="95%"/>
</div>
<div style="flex: 1; text-align: center;">
<p><strong>图2：服务器采用 CNA 网卡，融合以太网和存储网络</strong></p>
<img src="./assets/ch13_fcoe_after.png" width="95%"/>
</div>
</div>
...
<div style="display: flex; justify-content: space-between; gap: 10px;">
<div style="flex: 1; text-align: center;">
<img src="./assets/ch13_table2-1_before.png" width="95%"/>
</div>
<div style="flex: 1; text-align: center;">
<img src="./assets/ch13_table2-2_after.png" width="95%"/>
</div>
</div>
